...
export const meta: MetaFunction = () => [
  { title: "Admin Dashboard - Exam Prep Platform" },
  { name: "description", content: "Admin dashboard for managing exams, questions, and users." },
];
...
export async function loader({ request }: LoaderFunctionArgs) {
  try {
    ...
    const [userCount, examCount, questionCount, quizCount] = await Promise.all([
      prisma.user.count(),
      prisma.exam.count(),
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="text-lg font-medium text-gray-900">{stats.exams}</dd>
                    </dl>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <button className="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500 hover:bg-gray-50 rounded-lg border">
                  <div>
                  ...
                  <div className="mt-8">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Add a new competitive exam to the platform
                    </p>
                  </div>
                </button>
